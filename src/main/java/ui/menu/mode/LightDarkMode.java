...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("icon/menu/mode/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("icon/menu/mode/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("icon/menu/mode/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("icon/menu/mode/light.svg"));
        }
    }

 ...
 */
package com.ebenezer.pos.gui.dialog.au;

import com.ebenezer.pos.Ebenezer;
import com.ebenezer.pos.data.dao.impl.RoleDAOImpl;
import com.ebenezer.pos.data.dao.impl.UserAccountDAOImpl;
import com.ebenezer.pos.gui.JFrameAldrinPOS;
import com.ebenezer.pos.model.Role;
...
public class JDialogUserAccountAU extends javax.swing.JDialog {
        ...
        try {
            ...
            if (returnVal == javax.swing.JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    ImageIO.write(resizedImage, "png", new File(Ebenezer.class.getProtectionDomain().getCodeSource().getLocation().getPath() + "\\images\\model.jpg"));
    ...
    private void validatePhoto() throws URISyntaxException {
        if (userAccount.getPhoto() == null) {
            File targetClassesDir = new File(Ebenezer.class.getProtectionDomain().getCodeSource().getLocation().getPath() + "\\images\\no photo.jpg");
            try {
